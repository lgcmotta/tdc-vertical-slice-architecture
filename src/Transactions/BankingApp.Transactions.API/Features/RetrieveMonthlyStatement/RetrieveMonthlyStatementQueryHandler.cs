...
public class RetrieveMonthlyStatementQueryHandler : IRequestHandler<RetrieveMonthlyStatementQuery, IEnumerable<RetrieveMonthlyStatementModel>>
{
    private readonly AccountsDbContext _context;

    public RetrieveMonthlyStatementQueryHandler(AccountsDbContext context)
    {
        _context = context;
    }

    public async Task<IEnumerable<RetrieveMonthlyStatementModel>> Handle(RetrieveMonthlyStatementQuery request, CancellationToken cancellationToken)
    {
        ...
        var periodStatement = account.Transactions.Select(transaction =>
        {
            ...
            return new RetrieveMonthlyStatementModel
            {
