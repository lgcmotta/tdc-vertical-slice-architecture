...
public class YearlyStatementQueryHandler : IRequestHandler<YearlyStatementQuery, IEnumerable<YearlyStatementModel>>
{
    private readonly AccountsDbContext _context;

    public YearlyStatementQueryHandler(AccountsDbContext context)
    {
        _context = context;
    }

    public async Task<IEnumerable<YearlyStatementModel>> Handle(YearlyStatementQuery request, CancellationToken cancellationToken)
    {
        ...
        var periodStatement = account.Transactions.Select(transaction =>
        {
            ...
            return new YearlyStatementModel
            {
